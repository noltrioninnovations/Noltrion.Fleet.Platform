...
{
    /// <inheritdoc />
    public partial class Reinit_SQL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    RequiredVehicleType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TruckType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ...
                    TimeWindowFrom = table.Column<TimeSpan>(type: "time", nullable: true),
                    TimeWindowTo = table.Column<TimeSpan>(type: "time", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingSource = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripJobs_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripJobs_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoOfPallets = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripJobs_JobId",
                table: "TripJobs",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_TripJobs_TripId",
                table: "TripJobs",
                column: "TripId");
